...
},
{
  ...
  blocks:[
    ...
    {time:"10:00",t:"Tour Parlamento Húngaro ★",bud:true,desc:"Único jeito de visitar por dentro é tour guiado de 45 min. Reserve com semanas de antecedência — horários em inglês esgotam rápido no verão. <b>Não-UE (brasileiro) ≈ 14.000 HUF (~€37)</b>. Entrada pelo Centro de Visitantes (lado norte). Leve passaporte.",bestTime:"Tour das 10h em inglês — chegue 15 min antes",tags:["RESERVA OBRIGATÓRIA","Tour guiado 45 min","Passaporte na entrada","~€37 não-UE"],
      ticket:{label:"Reservar (parlament.hu oficial)",url:"https://www.parlament.hu/web/visitors/purchasing-tickets",official:true},img:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Hungarian_Parliament_Building_from_across_the_Danube%2C_2025-01-11.jpg/1280px-Hungarian_Parliament_Building_from_across_the_Danube%2C_2025-01-11.jpg",map:"Hungarian Parliament Building Budapest",solo:"high"},
    {time:"11:15",t:"Praça Kossuth + margem do Danúbio",bud:true,desc:"Saindo do tour, dê uma volta pela praça (estátuas, memorial dos sapatos do Danúbio fica 5 min ao sul) e caminhe pela margem em direção à Ponte das Correntes — ~15 min de caminhada com o Parlamento atrás e Buda do outro lado.",bestTime:"Luz da manhã sobre a água",tags:["Memorial dos Sapatos (5 min sul)","Caminhada margem"],map:"Shoes on the Danube Bank Budapest",solo:"high"},
    {time:"12:00",t:"Travessia da Ponte das Correntes ★",bt:true,bud:true,desc:"A Széchenyi Lánchíd recém-restaurada (reabriu 2024). ~10 min de Pest a Buda, vista 360º do Danúbio. No outro lado: Clark Ádám tér, base do funicular Sikló.",bestTime:"Sol alto — Danúbio brilhando",tags:["~10 min a pé","Reaberta em 2024"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Sz%C3%A9chenyi_Chain_Bridge_in_Budapest_at_night.jpg/1280px-Sz%C3%A9chenyi_Chain_Bridge_in_Budapest_at_night.jpg",map:"Szechenyi Chain Bridge Budapest",solo:"high"},
    {time:"12:30",t:"Funicular Sikló → topo do Castelo",bt:true,bud:true,desc:"O Sikló sobe em ~2 min até o bairro do castelo. ~2.000 HUF só ida; ou suba a pé pelas escadas (10 min) se quiser economizar.",tags:["~2 min","Ida ~2.000 HUF","Ou escadas grátis"],map:"Siklo funicular Budapest",solo:"high"},
    {time:"13:00",t:"Almoço no bairro do Castelo",bud:true,desc:"Pare para comer no bairro do castelo ou desça brevemente para Batthyány tér com vista do Parlamento. Opções com vista turísticas, mas a paisagem compensa.",map:"Buda Castle District Budapest"},
    {time:"14:30",t:"Castelo de Buda + Igreja Matthias",bud:true,desc:"Explore os pátios do castelo (Budavári Palota — grátis) e a <b>Igreja Matthias</b> ao lado do Bastião (telhado de azulejos coloridos). Por dentro da Matthias é pago; por fora já vale a foto. Reserve a subida ao Bastião pra noite (volta às 19:30 com luz dourada).",bestTime:"Pátios são grátis; Matthias interior pago",tags:["Pátios grátis","Matthias por fora basta","Volta ao Bastião à noite"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Budav%C3%A1ri_Palota%2C_ABCDEF_%C3%A9p%C3%BClet.jpg/1280px-Budav%C3%A1ri_Palota%2C_ABCDEF_%C3%A9p%C3%BClet.jpg",map:"Buda Castle Budapest",solo:"high"},
    {time:"17:00",t:"Volta ao hotel — pausa real",bt:true,desc:"Metrô ou táxi de volta ao The Amberlyn Suite. Descanse antes do bloco final do dia (Bastião + jantar).",tags:["Recuperar pra noite"],map:"The Amberlyn Suite Hotel Budapest"},
  ...
  tips:["<b>Reserve o Parlamento JÁ</b> — tour em inglês esgota 2-4 semanas antes, principalmente no verão.","Passaporte na entrada do Parlamento (não-UE).","Se o pôr do sol estiver nublado, o Bastião continua mágico à noite, todo iluminado.","Calçado firme: a subida ao castelo tem ladeiras e paralelepípedos."]
},
{
...
export const RESERVAS = [
  ...
  {p:1, when:"🔴 AGORA — agendado pra qua 3/jun 10:00", t:"Parlamento Húngaro (qua 3/jun)",
   d:"<b>Encaixado no roteiro às 10h de qua 3/jun</b>, antes do Castelo de Buda. Tour guiado de 45 min, horários em inglês esgotam 2–4 semanas antes — reserve já. Não-UE (brasileiro) ≈ 14.000 HUF. Passaporte na entrada. Plano B: ingressos de última hora liberados às 8h no centro de visitantes.",
