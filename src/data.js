...
},
{
  ...
  blocks:[
    ...
    {time:"17:15",t:"Mercado de San Antón (Chueca)",desc:"Da Puerta del Sol, sobe pela Calle Fuencarral até o <b>Mercado de San Antón</b>, mercado gastronômico em Chueca — versão local e descontraída do San Miguel (que você já fez). Lanchinho, vermut, e descanso.",bestTime:"Fim de tarde antes do jantar",tags:["NOVO pra você","Aberto até tarde"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Mercado_de_San_Anton_during_World_Pride.jpg/800px-Mercado_de_San_Anton_during_World_Pride.jpg",map:"Mercado de San Anton Madrid",solo:"high"},
    {time:"18:30",t:"Caminhada Conde Duque + Plaza de España",desc:"Volta tranquila pelo bairro de <b>Conde Duque</b> (vizinho de Malasaña, mais calmo e local) até a recém-restaurada <b>Plaza de España</b>, com a estátua de Don Quixote e Sancho Pança. NOVO pra você — fica ao lado do hotel.",tags:["Bairro novo pra você","A 2 min do hotel"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Plaza_de_Espa%C3%B1a_de_Madrid_-_02.jpg/800px-Plaza_de_Espa%C3%B1a_de_Madrid_-_02.jpg",map:"Plaza de España Madrid",solo:"high"},
    {time:"≈20:30",t:"Pôr do sol no Templo de Debod ★",desc:"Templo egípcio de verdade, de graça, no melhor mirante de pôr do sol de Madri — você confirmou que não foi ano passado. Chegue ~1h antes para garantir lugar.",bestTime:"Pôr do sol ≈ 21:40 no início de junho",tags:["NOVIDADE pra você","Grátis","Lotado no fim de tarde — vá cedo"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Templo_de_Debod_in_Madrid.jpg/800px-Templo_de_Debod_in_Madrid.jpg",map:"Templo de Debod Madrid",solo:"high"}
  ],
...
},
{
  ...
  blocks:[
    ...
    {time:"13:00",t:"New York Café",bud:true,desc:"\"O café mais bonito do mundo\". Almoço/café reservado direto pela Tableversum (#0385) — fura a fila que de dia é longa. Smart casual.",bestTime:"Mesa garantida — chegue uns 10 min antes",tags:["Smart casual — evite chinelo/regata","Café/bolo ~€10–12"],
      confirmed:{id:"0385",at:"Ter 2/jun · 13:00"},img:"https://upload.wikimedia.org/wikipedia/en/thumb/5/58/Anantara_New_York_Palace_Budapest_Hotel.png/800px-Anantara_New_York_Palace_Budapest_Hotel.png",map:"New York Cafe Budapest",solo:"med"},
    {time:"14:30",t:"Basílica de Santo Estêvão + terraço panorâmico",bud:true,desc:"Suba ao terraço (elevador ou 364 degraus) para vista 360º. Entrada simples ~2.600 HUF; combinado com terraço + tesouro ~5.000 HUF.",bestTime:"Tarde — luz boa sobre os telhados de Pest",tags:["Ingresso na bilheteria ou online"],
      ticket:{label:"Site da Basílica",url:"https://www.bazilika.biz/",official:true},img:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Budapest_Szent_Istvan_Bazilika_R01.jpg/800px-Budapest_Szent_Istvan_Bazilika_R01.jpg",map:"St Stephens Basilica Budapest",solo:"high"},
    {time:"16:30",t:"Mercado Central + Lángos",bud:true,desc:"Nagyvásárcsarnok (Ter 6h–18h). Suba ao 1º andar e prove o <b>lángos</b> (massa frita com alho, creme e queijo) — pedido do roteiro cumprido. Depois, esticada pela Váci utca.",bestTime:"Antes das 18h (o mercado fecha)",tags:["Lángos!","Leve dinheiro/cartão"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/VasarcsarnokFotoThalerTamas.JPG/800px-VasarcsarnokFotoThalerTamas.JPG",map:"Great Market Hall Budapest",solo:"high"},
...
},
{
  ...
  blocks:[
    {time:"09:00",t:"Castelo de Buda (Castle Hill)",bud:true,desc:"Suba cedo (funicular Sikló ou a pé) antes do calor e dos ônibus de turismo. Explore o bairro do castelo, pátios e mirantes.",bestTime:"Manhã cedo — fresco e vazio",tags:["Funicular ou caminhada","Pátios são grátis"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Budav%C3%A1ri_Palota%2C_ABCDEF_%C3%A9p%C3%BClet.jpg/800px-Budav%C3%A1ri_Palota%2C_ABCDEF_%C3%A9p%C3%BClet.jpg",map:"Buda Castle Budapest",solo:"high"},
    {time:"11:00",t:"Igreja Matthias + arredores",bud:true,desc:"Telhado de azulejos coloridos, ao lado do Bastião. Por dentro é pago; por fora já vale a foto.",tags:["A 2 min do Bastião"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Matthias_Church_2026.jpg/800px-Matthias_Church_2026.jpg",map:"Matthias Church Budapest",solo:"high"},
    ...
    {time:"15:00",t:"Pausa / Ponte das Correntes",bud:true,desc:"Tarde mais leve: descanse no hotel ou caminhe pela Széchenyi Lánchíd (Ponte das Correntes), recém-restaurada, ligando Buda a Pest.",bestTime:"Travessia a pé linda a qualquer hora",tags:["Recuperar energia para a noite"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Sz%C3%A9chenyi_Chain_Bridge_in_Budapest_at_night.jpg/800px-Sz%C3%A9chenyi_Chain_Bridge_in_Budapest_at_night.jpg",map:"Szechenyi Chain Bridge Budapest",solo:"high"},
    {time:"~19:30",t:"Pôr do sol no Fisherman's Bastion",bud:true,desc:"O pedido principal do roteiro. Volte ao Bastião dos Pescadores para o pôr do sol dourado sobre o Parlamento e o Danúbio. O terraço inferior é sempre grátis; as torres de cima custam ~1.700 HUF (grátis antes das 9h).",bestTime:"Chegue ~19:45 — pôr do sol ≈ 20:45",tags:["TEM que ver ☀","Terraço inferior grátis","Torres ~€4 (opcional)"],
      ticket:{label:"Info & ingressos (oficial)",url:"https://fishermansbastion.com/",official:true},img:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Hal%C3%A1szb%C3%A1stya_2017.jpg/800px-Hal%C3%A1szb%C3%A1stya_2017.jpg",map:"Fishermans Bastion Budapest",solo:"high"},
