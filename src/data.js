...
},
{
  ...
  blocks:[
    ...
    {time:"17:00",t:"Primeiro contato com Pest",desc:"Caminhe até a Basílica de Santo Estêvão (~15 min do hotel). À noite a praça fica iluminada e tranquila.",bestTime:"Fim de tarde, com a fachada iluminada",tags:["Dia leve de propósito"],map:"St Stephens Basilica Budapest",solo:"high"},
    {time:"20:00",t:"Jantar especial: Borkonyha Winekitchen ⭐",desc:"Michelin 1 estrela colado na Basílica (Sas u. 3, 5 min a pé). Bistrô descontraído, €40 a la carte ou tasting €86, 200+ vinhos húngaros. <b>Segunda é a única noite possível</b> da viagem — fecha aos domingos. Reserve com semanas de antecedência.",bestTime:"Reserve para ~20h",tags:["⭐ Michelin","€€€","RESERVA OBRIGATÓRIA","Foie gras com Tokaj Aszú é signature"],
      ticket:{label:"Reservar (oficial)",url:"https://borkonyha.hu/en/reservation/",official:true},img:"https://picsum.photos/seed/borkonyha/600/338",map:"Borkonyha Winekitchen Budapest",solo:"med"}
  ],
  ...
  tips:["O hotel tem cozinha equipada — dá para fazer um café da manhã em casa nos próximos dias."]
},
{
  ...
  blocks:[
    {time:"08:00",t:"Café da manhã no Cirkusz Café",bud:true,desc:"Brunch spot que aparece em todas as listas locais (4.7★ / 7.057 reviews). Pancakes, eggs benedict, café de especialidade. Não aceita reserva — chegue ~8h pra evitar fila de 30 min que se forma às 10h. Dob u. 25, ~15 min a pé do hotel.",bestTime:"Abertura 7:30 — chegue cedo",tags:["NOVO pra você","€€","Sem reserva"],map:"Cirkusz Cafe Budapest",solo:"high"},
    {time:"09:30",t:"Praça dos Heróis + Parque da Cidade",bud:true,desc:"Metrô M1 (a linha histórica) até Hősök tere. Monumento imponente + Castelo Vajdahunyad atrás. Tudo aberto e grátis.",bestTime:"Manhã, antes do calor e dos grupos",tags:["Grátis","M1 amarela"],map:"Heroes Square Budapest",solo:"high"},
    {time:"12:00",t:"New York Café",bud:true,desc:"\"O café mais bonito do mundo\". Reservas só para jantar (após 18h); de dia é por ordem de chegada e a fila pode ser longa. Chegue na abertura ou encare a espera (vale).",bestTime:"Logo na abertura (manhã) para evitar fila",tags:["Smart casual — evite chinelo/regata","Café/bolo ~€10–12"],
      ticket:{label:"Reservar jantar (site oficial)",url:"https://newyorkcafe.hu/en/table-reservation/",official:true},map:"New York Cafe Budapest",solo:"med"},
    {time:"14:30",t:"Basílica de Santo Estêvão + terraço panorâmico",bud:true,desc:"Suba ao terraço (elevador ou 364 degraus) para vista 360º. Entrada simples ~2.600 HUF; combinado com terraço + tesouro ~5.000 HUF.",bestTime:"Tarde — luz boa sobre os telhados de Pest",tags:["Ingresso na bilheteria ou online"],
      ticket:{label:"Site da Basílica",url:"https://www.bazilika.biz/",official:true},map:"St Stephens Basilica Budapest",solo:"high"},
    {time:"16:30",t:"Mercado Central + Lángos",bud:true,desc:"Nagyvásárcsarnok (Ter 6h–18h). Suba ao 1º andar e prove o <b>lángos</b> (massa frita com alho, creme e queijo) — pedido do roteiro cumprido. Depois, esticada pela Váci utca.",bestTime:"Antes das 18h (o mercado fecha)",tags:["Lángos!","Leve dinheiro/cartão"],map:"Great Market Hall Budapest",solo:"high"},
  ...
  food:{title:"Comidas do dia (encaixadas no fluxo)",city:"budapeste",rows:[
    {lbl:"Café manhã",it:"<b>Cirkusz Café</b> (Dob 25, 15min hotel) — <span>já está no roteiro às 8h.</span>",map:"Cirkusz Cafe Dob 25 Budapest",solo:"high"},
...
},
{
  ...
  intensity:"int", title:"Lado Buda + pôr do sol no Bastião",
  sub:"Castelo de Buda de manhã, Ponte das Correntes e o grande momento: pôr do sol no Fisherman's Bastion.",
  blocks:[
    {time:"09:00",t:"Castelo de Buda (Castle Hill)",bud:true,desc:"Suba cedo (funicular Sikló ou a pé) antes do calor e dos ônibus de turismo. Explore o bairro do castelo, pátios e mirantes.",bestTime:"Manhã cedo — fresco e vazio",tags:["Funicular ou caminhada","Pátios são grátis"],map:"Buda Castle Budapest",solo:"high"},
    {time:"11:00",t:"Igreja Matthias + arredores",bud:true,desc:"Telhado de azulejos coloridos, ao lado do Bastião. Por dentro é pago; por fora já vale a foto.",tags:["A 2 min do Bastião"],map:"Matthias Church Budapest",solo:"high"},
    {time:"13:00",t:"Almoço no lado Buda",bud:true,desc:"Pare para comer no bairro do castelo ou desça para Batthyány tér com vista do Parlamento.",map:"Buda Castle District Budapest"},
    {time:"15:00",t:"Pausa / Ponte das Correntes",bud:true,desc:"Tarde mais leve: descanse no hotel ou caminhe pela Széchenyi Lánchíd (Ponte das Correntes), recém-restaurada, ligando Buda a Pest.",bestTime:"Travessia a pé linda a qualquer hora",tags:["Recuperar energia para a noite"],map:"Szechenyi Chain Bridge Budapest",solo:"high"},
    {time:"~19:30",t:"Pôr do sol no Fisherman's Bastion",bud:true,desc:"O pedido principal do roteiro. Volte ao Bastião dos Pescadores para o pôr do sol dourado sobre o Parlamento e o Danúbio. O terraço inferior é sempre grátis; as torres de cima custam ~1.700 HUF (grátis antes das 9h).",bestTime:"Chegue ~19:45 — pôr do sol ≈ 20:45",tags:["TEM que ver ☀","Terraço inferior grátis","Torres ~€4 (opcional)"],
      ticket:{label:"Info & ingressos (oficial)",url:"https://fishermansbastion.com/",official:true},img:"https://picsum.photos/seed/fishermansbastion/600/338",map:"Fishermans Bastion Budapest",solo:"high"},
  ...
  tips:["Se o pôr do sol estiver nublado, o Bastião continua mágico à noite, todo iluminado.","Calçado firme: a subida ao castelo tem ladeiras e paralelepípedos."]
},
{
  ...
  blocks:[
    {time:"08:30",t:"Café da manhã: Espresso Embassy",bt:true,desc:"Café de especialidade pioneiro de Budapeste (Arany János 15, ~18 min a pé do hotel ou metrô M3). Reduto de profissionais locais, sem traço turístico. V60/espresso/cold brew + pastries. Última experiência de café húngaro antes do voo.",tags:["NOVO pra você","€","Sem reserva"],map:"Espresso Embassy Budapest",solo:"high"},
...
},
{
  ...
  blocks:[
    {time:"09:00",t:"Café da manhã no HanSo Café",desc:"Pioneiro do café de especialidade em Madri (Pez 20, Malasaña, 10 min do hotel). Tostadas leves + flat white antes do museu. Sem reserva, chegue ~9h.",tags:["NOVO pra você","€","Sem reserva"],map:"HanSo Cafe Madrid",solo:"high"},
    {time:"10:00",t:"Museu Thyssen-Bornemisza ★",desc:"O terceiro do triângulo de arte de Madri — você fez Prado e Reina Sofía ano passado, este é o que faltou. Coleção que vai do Renascimento até Pop Art, muito mais ampla cronologicamente; bem menos cheio. €13.",bestTime:"Abertura (10h) para evitar a fila",tags:["NOVIDADE pra você","€13","~1h30 de visita"],
      ticket:{label:"Ingressos (oficial)",url:"https://www.museothyssen.org/en/visit",official:true},map:"Museo Thyssen-Bornemisza Madrid",solo:"high"},
    {time:"12:00",t:"CaixaForum + jardim vertical",desc:"Centro cultural a 5 min do Thyssen, com a icônica fachada de jardim vertical de Patrick Blanc. Exposições temporárias surpreendentes, entrada ~€6. Bom escape da hora do calor.",tags:["NOVO pra você","€6"],map:"CaixaForum Madrid",solo:"high"},
    ...
    {time:"15:00",t:"Bairro de Salamanca — Calle Serrano ★",desc:"O \"milhão de ouro\" de Madri, a vibe é mais Paris que Madri: Loewe, Hermès, mas também Massimo Dutti, Sandro, Carolina Herrera. Calle Serrano + Calle Velázquez + Calle Ortega y Gasset. Cafés e gelaterias nas calçadas.",bestTime:"Tarde: ruas com sombra, ar-condicionado das lojas",tags:["NOVIDADE pra você","Luxe shopping","Vibe parisiense"],map:"Calle Serrano Madrid",solo:"high"},
    {time:"18:30",t:"Parque do Retiro com luz dourada",desc:"Desce de Salamanca pela Puerta de Alcalá e entra no Retiro com o sol já baixo (calor passou). Lago de barquinhos, Palácio de Cristal e o Palácio de Velázquez. Grátis.",bestTime:"Golden hour — luz baixa, calor passou",tags:["NOVIDADE pra você","Grátis","Barquinhos no lago"],map:"Parque del Retiro Madrid",solo:"high"},
    {time:"20:30",t:"Metrô para Chamberí — Plaza de Olavide",desc:"Praça arborizada cercada de terrazas, é onde os madrilenhos jovens se sentam num fim de tarde. Tomar uma cerveja gelada antes do jantar.",tags:["NOVO pra você","Reduto local"],map:"Plaza de Olavide Madrid",solo:"high"},
  ...
  food:{title:"Comidas do dia (rota completa)",city:"madrid",rows:[
    {lbl:"Café manhã",it:"<b>HanSo Café</b> (Pez 20, Malasaña, 10min hotel) — <span>especialidade pioneiro.</span>",map:"HanSo Cafe Pez 20 Madrid",solo:"high"},
...
},
{
  ...
  blocks:[
    {time:"09:00",t:"Café da manhã no Bianchi Kiosko Caffé",desc:"Espresso italiano de balcão (Pez 4, Malasaña, 7 min hotel). Modelo quiosque: você toma um café em pé em 5 minutos e segue. Vai te deixar a 15 min do Palácio.",tags:["NOVO pra você","€","Sem reserva"],map:"Bianchi Kiosko Cafe Madrid",solo:"high"},
    {time:"10:30",t:"Troca da Guarda no Palácio Real ★",desc:"Aos sábados há a cerimônia (≈11h, no verão pode começar às 10h) — grátis, na Plaza de la Armería. Você visitou o interior ano passado; agora é só pegar a cerimônia de fora. Chegue ~10:15 para bom lugar.",bestTime:"Sábado de manhã — única janela da viagem",tags:["NOVIDADE pra você","Grátis","Só quarta e sábado"],map:"Palacio Real de Madrid",solo:"high"},
    {time:"12:00",t:"Jardins de Sabatini",desc:"Atrás do palácio, GRÁTIS, raramente apareceu no roteiro do ano passado. Lago, esculturas e vista pro Palácio Real. Volte aqui no fim do dia para o pôr do sol — é um dos melhores de Madri e não é o Debod.",tags:["NOVO pra você","Grátis"],map:"Jardines de Sabatini Madrid",solo:"high"},
    {time:"12:45",t:"Caminhada → Ermita de San Antonio de la Florida ★",desc:"~10 min descendo pelo Paseo de la Florida. <b>O teto da capela é todo afrescado por Goya</b>, e é onde ele está enterrado. Grátis, raramente cheia, fora do circuito turístico.",bestTime:"Antes do almoço — fecha 13h30 alguns dias",tags:["NOVIDADE pra você","Grátis","Goya original"],map:"Ermita San Antonio de la Florida Madrid",solo:"high"},
  ...
  food:{title:"Comidas do dia (tudo no fluxo)",city:"madrid",rows:[
    {lbl:"Café manhã",it:"<b>Bianchi Kiosko</b> (Pez 4) — <span>espresso italiano de balcão, já no roteiro 09:00.</span>",map:"Bianchi Kiosko Cafe Pez 4 Madrid",solo:"high"},
...
},
{
  ...
  sub:"Café de despedida, check-out e voo de volta ao Brasil.",
  blocks:[
    {time:"08:00",t:"Café de despedida",bt:true,desc:"Você fez San Ginés ano passado — desta vez prove o <b>Bianchi Kiosko Caffé</b> (Malasaña, café italiano local) ou um café tranquilo perto do hotel.",tags:["Última de Madri","NOVO pra você"],map:"Bianchi Kiosko Cafe Pez 4 Madrid",solo:"high"},
  ...
  food:{title:"Última de Madri",city:"madrid",rows:[
    {lbl:"Café",it:"<b>Bianchi Kiosko Caffé</b> (Malasaña) — <span>italiano cabide, NOVO pra você.</span>",map:"Bianchi Kiosko Cafe Pez 4 Madrid",solo:"high"}
  ]},
...
export const RESERVAS = [
  {p:1, when:"🔴 AGORA — janela única", t:"Borkonyha Winekitchen (Budapeste · seg 1/jun)",
   d:"⭐ Michelin 1 estrela. <b>Domingo fecha</b>, então sua única noite é segunda 1/jun, a primeira na cidade. Reserve já — esgota com semanas. Bistrô descontraído ao lado da Basílica, €40 mains a la carte ou tasting €86, 200+ vinhos húngaros. Signature: foie gras com Tokaj Aszú.",
  ...
  {p:1, when:"🔴 AGORA — sua janela em Budapeste é só 1–4 jun", t:"Parlamento Húngaro (se quiser visitar)",
   d:"Só pode ser visitado em tour guiado, e os horários em inglês/espanhol esgotam 2–4 semanas antes, ainda mais no verão. Como sua estadia é logo em junho, reserve imediatamente ou verifique ingressos de última hora liberados às 8h no centro de visitantes. Não-UE (brasileiro) ≈ 14.000 HUF.",
   link:{label:"Reservar (parlament.hu oficial)",url:"https://www.parlament.hu/web/visitors/purchasing-tickets",official:true},
  ...
  {p:3, when:"NÃO precisa reservar mesa", t:"New York Café (apenas café de manhã)",
   d:"De dia é por ordem de chegada, com filas longas. Sua visita é só para fotografar o interior + um café, então chegue na abertura (8h-9h). Reserva só faz sentido para jantar — não recomendo, comida é fraca para o preço.",
...
export const HOTELS = [
  ...
  {nm:"The Amberlyn Suite Hotel", city:"Budapeste", cls:"budapeste", dates:"1 jun → 4 jun · 3 noites",
   ci:"Seg 1 jun · a partir das 15:00", co:"Qui 4 jun · até 11:00", note:"Confirmado · Rökk Szilárd u. 4, Distrito VIII (Palace District). Apartamento com cozinha; metrô Rákóczi tér ao lado.",
   map:"The Amberlyn Suite Hotel Budapest"},
  {nm:"Grupotel Mayorazgo", city:"Madrid", cls:"madrid", dates:"4 jun → 7 jun · 3 noites",
   ci:"Qui 4 jun", co:"Dom 7 jun", note:"Confirmado · Cancelamento grátis · C. de la Flor Baja, 3 · 28013 Madrid, junto à Gran Vía / Plaza de España.",
