...
},
{
  ...
  blocks:[
    ...
    {time:"20:00",t:"Jantar especial: Borkonyha Winekitchen ⭐",desc:"Michelin 1 estrela colado na Basílica (Sas u. 3, 5 min a pé). Bistrô descontraído, €40 a la carte ou tasting €86, 200+ vinhos húngaros. <b>Segunda é a única noite possível</b> da viagem — fecha aos domingos. Reserve com semanas de antecedência.",bestTime:"Reserve para ~20h",tags:["⭐ Michelin","€€€","RESERVA OBRIGATÓRIA","Foie gras com Tokaj Aszú é signature"],
      ticket:{label:"Reservar (oficial)",url:"https://borkonyha.hu/en/reservation/",official:true},map:"Borkonyha Winekitchen Budapest",solo:"med"}
  ],
...
},
{
  ...
  blocks:[
    ...
    {time:"~19:30",t:"Pôr do sol no Fisherman's Bastion",bud:true,desc:"O pedido principal do roteiro. Volte ao Bastião dos Pescadores para o pôr do sol dourado sobre o Parlamento e o Danúbio. O terraço inferior é sempre grátis; as torres de cima custam ~1.700 HUF (grátis antes das 9h).",bestTime:"Chegue ~19:45 — pôr do sol ≈ 20:45",tags:["TEM que ver ☀","Terraço inferior grátis","Torres ~€4 (opcional)"],
      ticket:{label:"Info & ingressos (oficial)",url:"https://fishermansbastion.com/",official:true},map:"Fishermans Bastion Budapest",solo:"high"},
