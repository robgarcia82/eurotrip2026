...
},
{
  ...
  intensity:"int", title:"Parlamento, Castelo de Buda e jantar Bib Gourmand",
  sub:"Manhã no Parlamento em Pest, travessia da Lánchíd ao meio-dia, tarde no Castelo + Bastião dourado, à noite N28 em Pest (mesa 20h).",
  blocks:[
    ...
    {time:"14:00",t:"Castelo de Buda + Igreja Matthias",bud:true,desc:"Explore os pátios do castelo (Budavári Palota — grátis) e a <b>Igreja Matthias</b> ao lado do Bastião (telhado de azulejos coloridos). Por dentro da Matthias é pago; por fora já vale a foto.",bestTime:"Pátios são grátis; Matthias interior pago",tags:["Pátios grátis","Matthias por fora basta","Bastião logo a seguir"],img:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Budav%C3%A1ri_Palota%2C_ABCDEF_%C3%A9p%C3%BClet.jpg/1280px-Budav%C3%A1ri_Palota%2C_ABCDEF_%C3%A9p%C3%BClet.jpg",map:"Buda Castle Budapest",solo:"high"},
    {time:"16:30",t:"Fisherman's Bastion (golden hour da tarde)",bud:true,desc:"O Bastião dos Pescadores fica colado na Matthias — já está aqui. Luz dourada da tarde sobre o Parlamento e o Danúbio (o pôr do sol pleno é 20:45, mas o jantar do N28 está marcado pra 20h em Pest, então fica essa janela mais cedo). O terraço inferior é sempre grátis; as torres de cima custam ~1.700 HUF.",bestTime:"~16:30-17:30 — luz quente, ainda dá tempo",tags:["TEM que ver ☀","Terraço inferior grátis","Torres ~€4 (opcional)"],
    ...
    {time:"17:45",t:"Descida do castelo + travessia pra Pest",bt:true,bud:true,desc:"Funicular ou escadas até Clark Ádám tér, atravessa de novo a Ponte das Correntes (agora a pé com vista do anoitecer chegando) e segue ao hotel pra freshen up rápido antes do jantar.",tags:["~25 min total"],map:"The Amberlyn Suite Hotel Budapest"},
    {time:"19:30",t:"Hotel → N28 Wine and Kitchen",bt:true,desc:"Metrô M1 (amarela, histórica) até Opera, ~10 min, depois 3 min a pé até Nagymező 28.",tags:["M1 amarela","~13 min total"],map:"N28 Wine and Kitchen Budapest"},
    {time:"20:00",t:"Jantar especial: N28 Wine and Kitchen ⭐",bud:true,desc:"Bib Gourmand Michelin 2025 (Nagymező 28, perto da Ópera). Cozinha húngara contemporânea, ~€40-50 com 2 pratos + vinho. <b>Mesa confirmada 20:00-21:00</b>. Após o jantar (~21h), dá pra dar uma volta pelo bairro do Teatro ou pegar uma vista noturna do Parlamento iluminado (M2 → Kossuth tér, 10 min) antes de voltar pro hotel.",bestTime:"Mesa confirmada para 20:00",tags:["⭐ Bib Gourmand","€€","Foie gras + paprika é signature"],
      confirmed:{at:"Qua 3/jun · 20:00",proof:"/img/reservations/n28-confirmation.jpg"},map:"N28 Wine and Kitchen Budapest",solo:"high"}
  ],
  food:{title:"Comidas do dia (lado Buda + Pest)",city:"budapeste",rows:[
    ...
    {lbl:"Jantar ⭐",it:"<b>N28 Wine and Kitchen</b> (Bib Gourmand) — <span>mesa confirmada às 20:00. Janela curta 20-21h.</span>",map:"N28 Wine and Kitchen Nagymezo 28 Budapest",solo:"high"},
  ...
  tips:["Tour interno do Parlamento esgotou pra sua janela — fachada + Memorial dos Sapatos cobrem o que precisa, e você ainda vê o Parlamento iluminado do cruzeiro (ter) e do Bastião à tarde.","Mesa N28 é 20-21h só (turno único). Saia do hotel 19:30 sem falta — M1 é a linha mais rápida.","Sunset pleno (20:45) você perde por causa do jantar, mas o Bastião à tarde + Parlamento iluminado pós-jantar (se quiser desvio rápido) cobrem o lado mágico."]
},
{
...
export const RESERVAS = [
  ...
  {p:2, confirmed:{at:"Qua 3/jun · 20:00",proof:"/img/reservations/n28-confirmation.jpg"}, when:"✓ Confirmado", t:"N28 Wine and Kitchen (Budapeste · qua 3/jun)",
   d:"⭐ Bib Gourmand Michelin 2025. <b>Mesa confirmada 20:00-21:00</b> (turno único, janela de 1h). Cozinha húngara contemporânea, ~€40-50 com 2 pratos + vinho. Nagymező 28, perto da Ópera — M1 amarela até Opera, 3 min a pé.",
   link:{label:"Site oficial",url:"https://n28.hu/",official:true},
